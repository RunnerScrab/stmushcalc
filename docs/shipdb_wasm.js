/* @ts-self-types="./shipdb_wasm.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function export_uploaded() {
    const ret = wasm.export_uploaded();
 ...
 * @returns {string[]}
 */
export function import_uploaded(bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.import_uploaded(ptr0, len0);
    var v2 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v2;
}
 ...
 * @returns {string[]}
 */
export function list_ships() {
    const ret = wasm.list_ships();
 ...
 * @returns {string}
 */
export function ship_art(name) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ship_art(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {Uint32Array}
 */
export function ship_counts() {
    const ret = wasm.ship_counts();
 ...
 * @returns {string}
 */
export function ship_table(name, eng, tac, helm, oper, sci, dam, wis) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ship_table(ptr0, len0, eng, tac, helm, oper, sci, dam, wis);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function simulate_summary(name, eng, tac, helm, oper, sci, dam, wis, timing) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(timing, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.simulate_summary(ptr0, len0, eng, tac, helm, oper, sci, dam, wis, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('shipdb_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
